...
//	ExtentReports extent = ReportManager.getReportManager().getExtentReporter();
	public void onTestStart(ITestResult result) {
		...
		TestManager.onTestStart( Thread.currentThread().getId(), result);
	}
	public void onTestSuccess(ITestResult result) {
		TestManager.onTestSuccess(Thread.currentThread().getId(), result);
	}
	public void onTestFailure(ITestResult result) {
		TestManager.onTestFailure(Thread.currentThread().getId(), result);
	}

	public void onTestSkipped(ITestResult result) {
		TestManager.onTestSkipped(Thread.currentThread().getId(), result);
	}
